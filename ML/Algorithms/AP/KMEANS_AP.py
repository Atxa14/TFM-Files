...
############################################################################################
# K range definition
clusterQuantity = range(1, 10)

# K parameter calculation
kmeans = [KMeans(n_clusters=i) for i in clusterQuantity]
score = [kmeans[i].fit(X).score(X) for i in range(len(kmeans))]

# Display Elbow Curve
plt.rcParams['figure.figsize'] = (10, 10)
plt.plot(clusterQuantity ,score)
...
# K-MEANS ##################################################################################
############################################################################################
# K selection de K and centroi calculation
kmeans = KMeans(n_clusters=4, n_init=100, max_iter=100).fit(X)
...
axes1.set_ylabel('snr', fontsize=22)
axes1.set_zlabel('avgrxpackets', fontsize=22)
axes1.scatter(centroids[:, 3], centroids[:, 2 ], centroids[:, 1], marker='*', c=colors2, s=200)
